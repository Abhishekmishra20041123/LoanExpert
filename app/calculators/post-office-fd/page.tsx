...
export default function PostOfficeFDCalculator() {
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Calculate Post Office Fixed Deposit maturity value
          </p>
        </div>
          ...
          <Card className="p-6 sm:p-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xs text-muted-foreground bg-muted p-3 rounded">
                * Post Office FD rates vary by scheme. This calculator uses current market rates for illustration purposes only.
              </p>
            </div>
          </Card>
